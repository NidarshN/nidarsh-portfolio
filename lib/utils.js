...
export const projects = [
    {
        ...
        live: (process.env.NEXT_PUBLIC_LOCALRAG_LINK == undefined ? "" : process.env.NEXT_PUBLIC_LOCALRAG_LINK),
    ...
    },
    {
        ...
        live: (process.env.NEXT_PUBLIC_ANOMALY_DET_LINK == undefined ? "" : process.env.NEXT_PUBLIC_ANOMALY_DET_LINK),
    ...
    },
    {
        ...
        live: (process.env.NEXT_PUBLIC_PORTFOLIO_LINK == undefined ? "" : process.env.NEXT_PUBLIC_PORTFOLIO_LINK),
